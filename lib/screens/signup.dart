                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Table(
                          ...
                          children: [
                            TableRow(children: [
                              ...
                              Text(
                                'Penggunaan Aplikasi : Anda diizinkan untuk menggunakan aplikasi ini hanya untuk tujuan yang sah, seperti menjelajahi informasi tentang Daftar mobil, merental mobil, dan melihat history mobil yang telah Anda Rental. Anda tidak diperkenankan menggunakan aplikasi ini untuk tujuan ilegal atau melanggar hukum yang berlaku.',
                                textAlign: TextAlign.left,
                                style: blackTextStyle.copyWith(
                            ...
                            TableRow(children: [
                              ...
                              Text(
                                'Investasi dan Keputusan Keuangan : Keputusan keuangan yang Anda buat adalah tanggung jawab Anda sendiri. Kami tidak memberikan jaminan atas hasil investasi atau keuntungan.',
                                textAlign: TextAlign.left,
                                style: blackTextStyle.copyWith(
                                    fontWeight: regular, fontSize: 14),
                              )
                      ...
                      const SizedBox(height: 10),
                      Text(
                        'Jika Anda memiliki pertanyaan atau komentar tentang syarat dan ketentuan ini, silakan hubungi kami melalui developer.rentailers@gmail.com. \n\nTerima kasih telah menggunakan Aplikasi Rentailers. Kami berharap Anda mendapatkan manfaat yang maksimal dari penggunaan aplikasi ini.',
                        textAlign: TextAlign.left,
                        style: greyTextStyle.copyWith(fontSize: 14),
                      )
                    ],
