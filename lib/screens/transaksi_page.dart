...
import 'package:mobile_apps/models/rents_models.dart';
import 'package:mobile_apps/models/rent_details_models.dart';
...
class TransaksiPage extends StatefulWidget {
  ...
  const TransaksiPage({Key? key, required this.customer, required this.nopol}) : super(key: key);
...
class _TransaksiPageState extends State<TransaksiPage> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate() && _tglSewa != null && _tglPengembalian != null && _tglPembayaran != null) {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'Lama Sewa (hari)'),
              ...
              ListTile(
                title: Text(_tglSewa == null ? 'Pilih Tanggal Sewa' : 'Tanggal Sewa: ${DateFormat('yyyy-MM-dd').format(_tglSewa!)}'),
              ...
              ListTile(
                title: Text(_tglPengembalian == null ? 'Pilih Tanggal Pengembalian' : 'Tanggal Pengembalian: ${DateFormat('yyyy-MM-dd').format(_tglPengembalian!)}'),
                trailing: Icon(Icons.calendar_today),
                onTap: () => _selectDate(context, (date) {
                  setState(() {
              ...
              ListTile(
                title: Text(_tglPembayaran == null ? 'Pilih Tanggal Pembayaran' : 'Tanggal Pembayaran: ${DateFormat('yyyy-MM-dd').format(_tglPembayaran!)}'),
                trailing: Icon(Icons.calendar_today),
                onTap: () => _selectDate(context, (date) {
                  setState(() {
                    _tglPembayaran = date;
